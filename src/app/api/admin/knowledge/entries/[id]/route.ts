        ...
        const result = await prisma.$transaction(async (tx) => {
            ...
            const updated = await tx.knowledgeBaseItem.update({
                ...
                data: {
                    ...
                    inputSchemaJson: body.inputSchemaJson !== undefined ? (body.inputSchemaJson ? JSON.parse(String(body.inputSchemaJson)) : Object.create(null)) : undefined,
                    outputSchemaJson: body.outputSchemaJson !== undefined ? (body.outputSchemaJson ? JSON.parse(String(body.outputSchemaJson)) : Object.create(null)) : undefined,
