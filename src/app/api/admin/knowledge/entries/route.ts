    ...
    try {
        ...
        const created = await prisma.knowledgeBaseItem.create({
            data: {
                ...
                inputSchemaJson: body.inputSchemaJson ? String(body.inputSchemaJson).trim() : null,
                outputSchemaJson: body.outputSchemaJson ? String(body.outputSchemaJson).trim() : null,
